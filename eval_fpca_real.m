...
[fL_u,fL_sigma,fL_v,fS_u,fS_sigma,fS_v] = RobustPCA(Y);
...
if params.fpca_fixed_run == 1
  ...
  [loL_u,loL_sigma,loL_v,lS_u,loS_sigma,loS_v] = RobustPCA(Y);
  ...
  [hL_u,hL_sigma,hL_v,hS_u,hS_sigma,hS_v] = RobustPCA(Y);
